...
namespace homm\hommiconpicker\fields;

use homm\hommiconpicker\Hommiconpicker;
use homm\hommiconpicker\assetbundles\hommiconpicker\HommiconpickerAsset;
 ...
 * @since     1.0.0
 */
class HommiconpickerField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('hommiconpicker', 'HommiconpickerField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'hommiconpicker/_components/fields/HommiconpickerField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(HommiconpickerAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').HommiconpickerHommiconpickerField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'hommiconpicker/_components/fields/HommiconpickerField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,

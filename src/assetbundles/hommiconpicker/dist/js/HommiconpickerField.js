/**
 * hommiconpicker plugin for Craft CMS
 *
 * HommiconpickerField Field JS
 *
 * @author    Domenik Hofer
 * @copyright Copyright (c) 2019 Domenik Hofer
 * @link      homm.ch
 * @package   Hommiconpicker
 * @since     1.0.0HommiconpickerHommiconpickerField
 */

 ;(function ( $, window, document, undefined ) {

    var pluginName = "HommiconpickerHommiconpickerField",
        defaults = {
        };
